...
#ifndef SNAPMAKERMODULES_SRC_MODULE_PURIFIER_H_
#define SNAPMAKERMODULES_SRC_MODULE_PURIFIER_H_
...
#define PURIFIER_FAN_POWER PA4

#define PURIFIER_FAN_PWM_TIM PWM_TIM3, PWM_CH1
#define PURIFIER_FAN_PWM_PIN PA6

#define FAN_SPEED_CAPTURE_PARM PA7, 2
#define FILTER_ELEMENT_PIN PB3

#define PURIFIER_LIGHT_PIN PA8
#define PURIFIER_LIGHT_COUNT 12
#define PURIFIER_LIGHT_EXTI SOFT_EXTI_LINE2
...
#define LIFETIME_TO_ELEC_LOW {0, 320, 830, 1800,}
#define LIFETIME_TO_ELEC_NORMAL {0, 360,900, 2100}
#define OPEN_LID_TO_ELEC {0, 420, 1350, 3500}
...
class PurifierModule : public ModuleBase {
 ...
 private:
  ...
  uint16_t open_lid_limit_[FAN_GEARS_INVALID] = OPEN_LID_TO_ELEC;
  PURIFIER_STATUS_E sys_status_ = STA_IDLE;
  bool is_debug_ = false;
};

#endif //SNAPMAKERMODULES_SRC_MODULE_PURIFIER_H_
